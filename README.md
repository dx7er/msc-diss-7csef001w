...
Practical companion to the MSc dissertation: *Correlating Windows Artifacts Evidence to Reconstruct User Activity &mdash; A Forensic Analysis of Prefetch, Event Logs and ShellBags*.
